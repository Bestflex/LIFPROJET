...
$.getJSON('../json/dpt.json', function (data) {
	...
	for(var i = 0; i<102; i++)
	{
		...
		info.update = function (props) {
			this._div.innerHTML = '<h4>Nombre de feu par departement</h4>' +  (props ?
				'<b> Departement : ' + props.nom + '<br />Moyenne surface brulée : ' + roundDecimal(props.surface,2)  + ' m<sup>2</sup><br />Nombre de feu de 2006 à 2021 : ' + props.nbfeu + '</b>'
...
//function qui arrondie au centieme
