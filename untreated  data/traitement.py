...
def treat_position():
    ...
    dectX = {}
    dectY = {}
    with open('code_insee_et_geoloc_la-post.csv', encoding='utf-8') as infile:
...
def treat_precipitation():
    insert = "insert into precipitation (posx, posy, presMoyJour, integNbJoursPluis, integNbMaxJoursPluisConsec," \
             " periodeSecheress)"
    with open('precipitation_meteo-france.txt') as infile:
